    ...
    <>
      <div data-custom-class="body" className="max-w-3xl">
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ color: "rgb(255, 255, 255)" }}>
            <span style={{ color: "rgb(255, 255, 255)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                This Cookie Policy explains how <strong>Company</strong>," "
            ...
            <span style={{ color: "rgb(34, 197, 94)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                <a
                  href="https://tradetrender.com"
                  target="_blank"
                  data-custom-class="link"
                >
                  https://tradetrender.com
                </a>
              </span>
            </span>
            <span style={{ color: "rgb(255, 255, 255)", fontSize: 15 }}>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ color: "rgb(255, 255, 255)" }}>
            <span style={{ color: "rgb(255, 255, 255)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                Cookies set by the website owner (in this case, "first-party
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ color: "rgb(255, 255, 255)" }}>
            <span style={{ color: "rgb(255, 255, 255)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                We use first- party cookies for several reasons. Some cookies
          ...
          <span style={{ color: "rgb(255, 255, 255)" }}>
            <span style={{ color: "rgb(255, 255, 255)", fontSize: 15 }}>
              <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                  <span id="control" style={{ color: "rgb(255, 255, 255)" }}>
                    <strong>
                      <span data-custom-class="heading_1">
                  ...
                  >
                    ...
                    <td style={{ display: "inline-block", marginLeft: 5 }}>
                      ...
                      >
                        ...
                        access customer sites protected by Bot Management or Bot
                        Fight Mode.
                      </span>
                    </td>
                  </tr>
            ...
            <span style={{ color: "rgb(255, 255, 255)", fontSize: 15 }}>
              ...
              <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                <span data-custom-class="body_text">
                  ...
                  including them us, for example, to monitor&nbsp;
                </span>
                <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                  <span style={{ color: "rgb(255, 255, 255)" }}>
                    <span data-custom-class="body_text">
              ...
              <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                  <span style={{ color: "rgb(255, 255, 255)" }}>
                    <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                      <span
                        style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}
                      >
                        <strong>
                          <span data-custom-class="heading_1">
            ...
            <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
              <span style={{ fontSize: 15, color: "rgb(255, 255, 255)" }}>
                <span data-custom-class="body_text">
                  ...
                  technologies, you may email us at privacy@tradetrender.com.
                </span>
              </span>
            </span>
          </span>
