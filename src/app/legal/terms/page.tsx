function Page() {
  return (
    <>
      <div data-custom-class="body" className="max-w-3xl">
        <div>
          <strong>
        ...
        <br></br>
        <h3>
          <strong>Agreement between User and Trade Trender</strong>
        </h3>
        <br></br>
        <p>
          Welcome to Trade Trender. The Trade Trender website (the "Site") is
          comprised of various web pages operated by Dev 22 LLC. Trade Trender
          is offered to you conditioned on your acceptance without modification
          of the terms, conditions, and notices contained herein (the "Terms").
          Your use of Trade Trender constitutes your agreement to all such
          Terms. Please read these terms carefully, and keep a copy of them for
          your reference.
        </p>
        <br></br>
        <p>
          Trade Trender allows users to record stock trades as a journal and
          encourages learning and development to become better traders.
        </p>
        <br></br>
        <h3>
        ...
        <br></br>
        <p>
          Visiting Trade Trender or sending emails to Dev 22 LLC constitutes
        ...
        <br></br>
        <h3>
          <strong>Prohibited Activites</strong>
        </h3>
        <br></br>
        <p>
        ...
        <br></br>
        <p>
          Dev 22 LLC does not knowingly collect, either online or offline,
          personal information from persons under the age of thirteen. If you
          are under 18, you may use Trade Trender only with permission of a
          parent or guardian.
        </p>
        <br></br>
        <h3>
        ...
        <br></br>
        <p>There are no refunds offered at this time.</p>
        <br></br>
        <h3>
        ...
        <br></br>
        <p>
          Trade Trender may contain links to other websites ("Linked Sites").
          The Linked Sites are not under the control of Dev 22 LLC and Dev 22
          LLC is not responsible for the contents of any Linked Site, including
          without limitation any link contained in a Linked Site, or any changes
          or updates to a Linked Site. Dev 22 LLC is providing these links to
          you only as a convenience, and the inclusion of any link does not
          imply endorsement by Dev 22 LLC of the site or any association with
          its operators.
        </p>
        <br></br>
        <p>
          Certain services made available via Trade Trender are delivered by
          third party sites and organizations. By using any product, service or
          functionality originating from the Trade Trender domain, you hereby
          acknowledge and consent that Dev 22 LLC may share such information and
          data with any third party with whom Dev 22 LLC has a contractual
          relationship to provide the requested product, service or
          functionality on behalf of Trade Trender users and customers.
        </p>
        <br></br>
        <h3>
        ...
        <p>
          ...
          to access and use Trade Trender strictly in accordance with these
          terms of use. As a condition of your use of the Site, you warrant to
          Dev 22 LLC that you will not use the Site for any purpose that is
        ...
        <p>
          ...
          used on the Site, is the property of Dev 22 LLC or its suppliers and
        ...
        <p>
          ...
          Dev 22 LLC content is not for resale. Your use of the Site does not
          ...
          content without the express written permission of Dev 22 LLC and the
          ...
          express or implied, to the intellectual property of Dev 22 LLC or our
        ...
        <br></br>
        <p>
          You will be able to connect your Dev 22 LLC account to third party
          accounts. By connecting your Dev 22 LLC account to your third party
        ...
        <br></br>
        <p>
          The Service is controlled, operated and administered by Dev 22 LLC
          ...
          local laws. You agree that you will not use the Dev 22 LLC Content
          accessed through Trade Trender in any country or in any manner
        ...
        <br></br>
        <p>
          You agree to indemnify, defend and hold harmless Dev 22 LLC, its
          ...
          rules or regulations. Dev 22 LLC reserves the right, at its own cost,
          ...
          cooperate with Dev 22 LLC in asserting any available defenses.
        </p>
        <br></br>
        <h3>
        ...
        <p>
          ...
          Further, unless both you and Dev 22 LLC agree otherwise, the
        ...
        <p>
          ...
          ERRORS. CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. DEV
          22 LLC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
          THE SITE AT ANY TIME.
        </p>
        <br></br>
        <p>
          DEV 22 LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
          ...
          CONDITION OF ANY KIND. DEV 22 LLC AND/OR ITS SUPPLIERS HEREBY DISCLAIM
        ...
        <p>
          ...
          DEV 22 LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
          ...
          STRICT LIABILITY OR OTHERWISE, EVEN IF DEV 22 LLC OR ANY OF ITS
        ...
        <br></br>
        <p>
          Dev 22 LLC reserves the right, in its sole discretion, to terminate
          ...
          by law, this agreement is governed by the laws of the Commonwealth of
          Pennsylvania and you hereby consent to the exclusive jurisdiction and
          venue of courts in Pennsylvania in all disputes arising out of or
        ...
        <p>
          ...
          relationship exists between you and Dev 22 LLC as a result of this
          agreement or use of the Site. Dev 22 LLC's performance of this
          agreement is subject to existing laws and legal process, and nothing
          contained in this agreement is in derogation of Dev 22 LLC's right to
          ...
          to or gathered by Dev 22 LLC with respect to such use. If any part of
        ...
        <p>
          ...
          entire agreement between the user and Dev 22 LLC with respect to the
          ...
          Dev 22 LLC with respect to the Site. A printed version of this
        ...
        <br></br>
        <p>
          Dev 22 LLC reserves the right, in its sole discretion, to change the
          Terms under which Trade Trender is offered. The most current version
          of the Terms will supersede all previous versions. Dev 22 LLC
        ...
        <br></br>
        <p>
          Dev 22 LLC welcomes your questions or comments regarding the Terms by
          emailing evan@tradetrender.com
        </p>
        <br></br>
      </div>
    </>
